...
function resetTotalGameEngine() {
    ...
    DOM.playerInputs.A.value = 'Pemain A'; DOM.playerInputs.B.value = 'Pemain B'; DOM.playerInputs.C.value = 'Pemain C'; DOM.playerInputs.D.value = 'Pemain D';
    DOM.customTarget.value = '';
    DOM.targetButtons.forEach(b => b.classList.remove('active'));
...
function enqueueSpeech(text) {
    speechQueue.push(text.replace(/-/g, ' minus ').replace(/0/g, ' nol '));
    processSpeechQueue();
}
